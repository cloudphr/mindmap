...
public class XmindParserTest {
  ...
  public void testParseSimpleXmindFile() {
    ...
    assertNull(firstTopic.getLink());
    assertNull(firstTopic.getNote());
    ...
    assertNull(secondTopic.getLink());
    assertNull(secondTopic.getNote());
    ...
    assertNull(thirdTopic.getLink());
    assertNull(thirdTopic.getNote());
    ...
    assertNull(fourthTopic.getLink());
    assertNull(fourthTopic.getNote());
    ...
    assertNull(fifthTopic.getLink());
    assertNull(fifthTopic.getNote());
    ...
    assertNull(sixthTopic.getLink());
    assertNull(sixthTopic.getNote());
    ...
    assertNull(seventhTopic.getNote());
